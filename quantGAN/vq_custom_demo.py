...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-path", type=str, default="/media/mlr_lab/6E18DC183015F19C/Ashu/Ashutosh_Dataset/VLN/Docker_Base/Matterport3DSimulator/data/v1/scans/1pXnuDYAj8r/matterport_skybox_images/0d3a3b42009441e2a02200423049d804_skybox0_sami.jpg")
